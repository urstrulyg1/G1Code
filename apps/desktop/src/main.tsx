...
function App() {
  ...
  const [panel, setPanel] = useState<"terminal" | "activity">("terminal");
  ...
  useEffect(() => {
    ...
    const offEvent = window.g1code.onAgentEvent((value) => {
      ...
      if (
        event.type === "done" ||
        ["COMPLETED", "FAILED", "STOPPED"].includes(event.state ?? "")
      )
        setRunning(false);
      setPanel("activity");
    });
        ...
        <main className="editor-area">
          ...
          {current ? (
            ...
            <div className="welcome">
              ...
              <p>
                Open a workspace, configure a provider, and ask G1Code to
                inspect or change your project.
              </p>
              <button className="primary" onClick={openWorkspace}>
          ...
          <div className="bottom-panel">
            ...
            {panel === "terminal" ? (
              <div className="terminal">
                <pre>
                  {terminal ||
                    "Terminal ready. Commands run in the active workspace."}
                </pre>
        ...
        <aside className="agent">
          ...
          <div className="agent-empty">
            {events.length ? (
              ...
              <>
                ...
                <p>
                  Ask about your codebase, plan a change, or start an
                  implementation task.
                </p>
                <div
                ...
                <div
                  className="prompt-chip"
                  onClick={() => setPrompt("Find the build command")}
                >
          ...
          <div className="agent-input">
            <textarea
              ...
              placeholder="Ask G1Code anything..."
              onKeyDown={(event) =>
                event.key === "Enter" &&
                !event.shiftKey &&
          ...
          <div className="palette" onClick={(event) => event.stopPropagation()}>
            ...
            {[
              ...
              <button
                ...
                onClick={() => {
                  setPalette(false);
                  if (index === 0) void openWorkspace();
                  if (index === 3) setSettingsOpen(true);
                }}
              >
                {item}
              </button>
      ...
      {permission && (
        <div className="modal-backdrop">
          <div className="settings-card permission-card">
            ...
            <h2>G1Code wants to run {permission.tool}</h2>
